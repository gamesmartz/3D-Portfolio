      ...
      <div class="row">
        ...
        <div class="col-lg-6 my-auto">
         <h1>Hi, I'm Matt Norkaitis</h1>
          <hr class="colored">
            <p>I am an artist and developer living in Irvine Ca, all the images and content on this site are my own.  My current company is <a style="color: #00A3FF" href="https://gamesmartz.com">Gamesmartz</a>, a teaching platform where users get to play their favorite games, watch videos and surf the web while learning. GameSmartz currently boats of over <a style="color: #00A3FF" href="https://gamesmartz.com/flashcard-thumbs?grade=all&subject=science">2k flashcards</a> top ranking in the google image and serp results with a half-million questions answered.</p>
            <p>My past technical experience includes <a style="color: #00A3FF" href="3d-artist">13 years experience in 3d modeling / texturing for architecture and games</a>, <a style="color: #00A3FF" href="front-end-dev">8 years experience as a Front End Designer, two years experience as a software Developer</a>, <a style="color: #00A3FF" href="digital-painting">5 years experience as a photoshop painter</a> and 15 years experience as a single father.</p>
