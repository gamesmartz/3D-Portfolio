...
<body style="position: relative; " data-spy="scroll" data-target=".navbar" data-offset="50">
  <div id="navbar-target" class="container-fluid index-nav navbar">
    <ul class="nav hidden-nav d-flex fixed-top align-items-center justify-content-end nav-bar-shrink">
      <li class="nav-item">
        <a class="nav-link  active" href="#header-target">Home</a>
      </li>
      <li class="nav-item">
        ...
        <ul class="list-inline">
          <li class="list-inline-item">
            <a href="https://www.facebook.com/mnorkaitis">
              <svg class="svg-inline--fa fa-facebook-square fa-w-14 icon" aria-hidden="true" data-prefix="fab" data-icon="facebook-square"
          ...
          <li class="list-inline-item">
            <a href="https://www.linkedin.com/in/matthew-norkaitis-8a0a0831">
              <svg class="svg-inline--fa fa-linkedin-in fa-w-14 icon" aria-hidden="true" data-prefix="fab" data-icon="linkedin-in" role="img"
          ...
          <li class="list-inline-item">
            <a href="https://twitter.com/mattnorkaitis">
              <svg class="svg-inline--fa fa-twitter fa-w-16 icon" aria-hidden="true" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg"
  ...
  <iframe id="fillrChip" class="fillrChip" tabindex="-1" scrolling="no" src="chrome-extension://ojhegjfmbbpahdggoekcbmejnifimeca/chip.html"
    style="display none; position: absolute; background: transparent; width: 0px; height: 0px; border: none; z-index: 2147483647; box-shadow: 0 0 8px 0 rgba(0,0,0,0.12), 0 8px 8px 0 rgba(0,0,0,0.24);"></iframe>
</body>
